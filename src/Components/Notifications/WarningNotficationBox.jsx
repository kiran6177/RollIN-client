...
function WarningNotficationBox({notification}) {
  ...
  return (
    ...
    className='border-2 border-[#f6ae2d] rounded-md py-5 px-8 bg-black relative flex flex-col md:flex-row gap-8 w-[100%]' >
            ...
            <div className='flex flex-col gap-3'>
                <h2 className='text-[#f6ae2d] tracking-wider font-medium text-lg sm:text-xl '>Hey {theatreData?.name}, One of your movie enrollement is ending soon.</h2>
                <h2 className='text-[#f6ae2d] text-md'>{notification?.moviedata?.title}</h2>
                <h2 className='text-white text-sm'>Enroll movies to continue bookings.</h2>
            </div>
...
export default WarningNotficationBox
