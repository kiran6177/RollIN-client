        ...
        <div className='pt-28 px-12  min-h-[10rem]'>
            ...
            <div className='flex flex-wrap justify-evenly gap-8 my-10'>
            {
                ...
                allTheatresData.map(theatre=>{
                    return (
                        <div key={theatre?._id} onClick={()=>navigate(`/screenwithmovies?id=${theatre._id}`)} className=' border-2 border-[#f6ae2d] cursor-pointer rounded-md p-6 w-[90%] sm:w-[45%] md:w-[30%] bg-black flex flex-col gap-6'>
                            <h3 className='text-[#f6ae2d] font-medium'>{theatre?.name}</h3> 
