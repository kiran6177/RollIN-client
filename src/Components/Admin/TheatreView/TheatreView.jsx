            ...
            theatresData.map((theatre,i)=>{
              return (
                <React.Fragment key={theatre.id}>
                  <tr className='h-[4rem]' key={theatre.id+"sno"}><td className='w-[50%] border-collpase border border-[#f6ae2d] bg-[#f6ae2d] text-black font-semibold'>S.No</td><td className='w-[50%] border-collpase border border-[#f6ae2d] rounded-md text-sm sm:text-lg'>{i+1}</td></tr>
                  <tr className='h-[4rem]' key={theatre.id+"name"}><td className='w-[50%] border-collpase border border-[#f6ae2d] bg-[#f6ae2d] text-black font-semibold'>Name</td><td className='w-[50%] border-collpase border border-[#f6ae2d] rounded-md text-sm sm:text-lg'>{theatre.name}</td></tr>
                  <tr className='h-[4rem]' key={theatre.id+"email"}><td className='w-[50%] border-collpase border border-[#f6ae2d] bg-[#f6ae2d] text-black font-semibold '>Email</td><td className='w-[50%] border-collpase border border-[#f6ae2d] rounded-md text-sm sm:text-lg'>{theatre.email}</td></tr>
                  <tr className='h-[4rem]' key={theatre.id+"mobile"}><td className='w-[50%] border-collpase border border-[#f6ae2d] bg-[#f6ae2d] text-black font-semibold  '>Location</td><td className='w-[50%] border-collpase border border-[#f6ae2d] rounded-md text-xs'>{theatre.address?.completeLocation}</td></tr>
                  <tr className='h-[6rem]' key={theatre.id+"action"}><td className='w-[50%] border-collpase border border-[#f6ae2d] bg-[#f6ae2d] text-black font-semibold  '>Action</td><td className='w-[50%] border-collpase border border-[#f6ae2d] rounded-md text-sm sm:text-lg'>
                    <div className='flex flex-col gap-4 items-center xl:flex-row xl:justify-evenly '>
                        <button onClick={()=>viewTheatre(theatre.id)}  className='bg-[#f6ae2d] text-black px-6 py-2 rounded-sm font-medium'>View</button>
                    </div></td></tr>
