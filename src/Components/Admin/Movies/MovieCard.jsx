...
function MovieCard({movie}) {
  ...
  return (
    <div onClick={()=>navigate(`/admin/moviedetail?id=${movie?.movie_id}`)} className='h-[20rem] cursor-pointer w-[16rem]  border-2 border-[#f6ae2d] rounded-md overflow-hidden relative hover:scale-[1.02] transition-all duration-200 ease-in-out'>
      ...
      {movie?.isDisabled &&<p className='bg-red-600 px-2 py-1 text-white text-xs z-10 font-normal tracking-wider absolute bottom-6 right-5' >Disabled</p>}
